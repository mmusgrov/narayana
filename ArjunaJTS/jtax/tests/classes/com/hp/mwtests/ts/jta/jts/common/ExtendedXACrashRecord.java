...
public class ExtendedXACrashRecord extends XAResourceRecord
{
    ...
    public ExtendedXACrashRecord()
    {
        _cl = CrashLocation.NoCrash;
        _ct = CrashType.Normal;
    }

    public ExtendedXACrashRecord(CrashLocation cl, CrashType ct)
    {
        super(new Uid());
    ...
    public boolean save_state(OutputObjectState os, int ot)
    {
        ...
        return super.saveState(os);//save_state(os, ot);
    }
    ...
    public boolean restore_state(InputObjectState os, int ot)
    {
        ...
        return super.restoreState(os); //restore_state(os, ot);
    }
