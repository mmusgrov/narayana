...
/**
 * Initialises IbmORB RecoveryCoordinator creation subsystem
...
public class IbmOrbRCServiceInit implements RecoveryServiceInit
{
     ...
     * but the policies are usable by the IbmOrbRCManager to create the IOR's in
     * TS-using processes.
     */
    ...
    private static void initORBandOA() throws InvalidName
    {
        ...
        ORBManager.getPOA().addPreShutdown(new IbmOrbRCShutdown());
    }
