...
/**
 * Implementation of RecoveryCreator for IbmOrb
 * Handles the creation of RecoveryCoordinator objects for
 * IbmOrb .  The RCs are created locally but also will be
...
private POA _ourPOA;
	 ...
	 */
	String env = System.getProperty("com.arjuna.ats.internal.jts.orbspecific.ibmorb.recoverycoordinators.noDaemon");
