...
public class IbmOrbRCDefaultServant extends GenericRecoveryCoordinator
{
	...
	if (jtsLogger.logger.isDebugEnabled()) {
        jtsLogger.logger.debug("IbmOrbDefaultServant(orb)");
    }
    ...
    {
	if (jtsLogger.logger.isDebugEnabled()) {
        jtsLogger.logger.debug("IbmOrbDefaultServant::replay_completion)");
    }
	...
	try 
	 {
	     ...
	     if (jtsLogger.logger.isDebugEnabled()) {
             jtsLogger.logger.debug("IbmOrbDefaultServant replay_completion for Id "+recovCoId);
         }
