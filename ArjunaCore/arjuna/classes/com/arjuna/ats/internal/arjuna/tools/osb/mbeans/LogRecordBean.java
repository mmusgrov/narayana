...
public class LogRecordBean implements LogRecordWrapperMXBean {
   // public class LogRecordBean extends NamedOSEntryBeanMBeanImpl implements NamedOSEntryBeanMXBean, LogRecordWrapperMXBean {
    private BasicActionAccessor parent;
    ...
    public LogRecordBean(String parentObjectName, BasicActionAccessor baa, AbstractRecord ar, ParticipantStatus listType) {
        this(ar.type(), parentObjectName + ",puid=" + ar.order().fileStringForm(), ar.order().stringForm());
        this.parent = baa;
        this.ar = ar;
