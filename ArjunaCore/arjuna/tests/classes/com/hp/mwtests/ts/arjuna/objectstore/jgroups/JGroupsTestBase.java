...
public class JGroupsTestBase {
    ...
    record Store(JChannel channel,
//                 ReplCache<byte[], byte[]> cache,
                 String groupName,
        ...
        public Store(String configFile, String groupName, String nodeName, String storeDir) throws Exception {
            this(
                    new JChannel(configFile),
//                    null, // cache will be created during start()
                    groupName,
                    nodeName,
    ...
    static Store createStore(String nodeName, String groupName, String storeDir) throws Exception {
        return new Store("jgroups-transport-config.xml", groupName, nodeName, storeDir);
    }
