...
public class JGroupsTestBase {
    ...
    record Store(String groupName,
        ...
        public Store(String configFile, String groupName, String nodeName, String storeDir) throws Exception {
            this(
                    groupName,
                    nodeName,
...
//            config.setNumberOfSlots(256);
                ...
                if (config.getCache() != null) {
                    try {
                        ...
                        if ("null".equals(config.getCache().getView())) {
                            System.err.printf("ERROR: null view while stopping cache %s%n", config.getCache().getClusterName());
                        } else {
        ...
        public void start() throws Exception {
            ...
            // Configure the cache but don't start it - slots.init() will start it
            ...
            System.out.printf("recoveryStore.start()");
        }
    }

    static Store createStore(String nodeName, String groupName, String storeDir) throws Exception {
        return new Store("jgroups.xml", groupName, nodeName, storeDir);
    }
