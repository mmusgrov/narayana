...
public class ClientVerticle extends AbstractVerticle {
    ...
    public static String SLOT0 = "SLOT_0";
    public static String SLOT1 = "SLOT_1";
    public static String SLOT2 = "SLOT_2";
  ...
  public void start() {
    ...
    map.put(SLOT0, "client data");

      vertx.deployVerticle(new SampleVerticle1());

      final int INSTANCE_CNT = 1;
      for (int i = 0; i < INSTANCE_CNT; i++)
          vertx.deployVerticle(new SampleVerticle2());

      System.out.printf("Before Slot_1: %s%n", map.get(SLOT1));
      System.out.printf("Before Slot_2: %s%n", map.get(SLOT2));

      vertx.eventBus().<String>consumer("sample.data", message -> {
          System.out.printf("[Main] Consuming data: %s%n", message.body());
          System.out.printf("After Slot_1: %s%n", map.get(SLOT1));
          System.out.printf("After Slot_2: %s%n", map.get(SLOT2));
