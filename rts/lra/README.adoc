...
java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005 -cp lra-test/target/classes:lra-test/target/lra-test/WEB-INF/lib/jackson-jaxrs-json-provider-2.7.4.jar:lra-test/target/lra-test/WEB-INF/lib/javax.json-1.0.3.jar:lra-coordinator/target/lra-coordinator/WEB-INF/lib/jackson-databind-2.7.4.jar:lra-coordinator/target/lra-coordinator/WEB-INF/lib/jackson-core-2.7.4.jar:lra-test/target/lra-test/WEB-INF/lib/jackson-annotations-2.8.0.jar -Dservice.http.port=8081 TripClient
```
