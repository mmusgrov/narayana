...
public class AgroalH2Utils {
    ...
    public static final String DB_PASSWORD = "";
     ...
     static String TEST_TABLE_NAME = "TXN_DRIVER_TEST";
     static String CREATE_TABLE = String.format("CREATE TABLE if not exists %s(id int primary key, name varchar(42))", TEST_TABLE_NAME);
     static String DROP_TABLE = String.format("DROP TABLE if exists %s", TEST_TABLE_NAME);
     static String SELECT_QUERY = String.format("SELECT * FROM %s", TEST_TABLE_NAME);
